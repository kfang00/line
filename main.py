...
while x < 200:
    c = [ 250, 0, 23 ]
    draw_line((XRES) - 2 * x, (YRES / 3) - 4 * x, XRES/2, 0, s, c);
    draw_line(XRES/2, 0, (XRES / 4) + 3 * x, (YRES / 2) + x, s, c);
    c = [ 231, 174, 34 ]
    draw_line((XRES) + 2 * x, (YRES / 3) + 4 * x, 0, YRES/2, s, c);
    draw_line(0, YRES/2, (XRES / 4) - 3 * x, (YRES / 2) - x, s, c);
